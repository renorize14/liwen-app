...
Route::get('/get-blocks-by-id', [ReservationsController::class, 'getFreeBlocksById'])->name('get-blocks-by-id');

Route::post('/make-reservation', [ReservationsController::class, 'makeNewReservation'])->name('make-reservation');
...
Route::post('/login-prof', [SessionsController::class, 'logIn'])->name('login-prof');

Route::get('/get-user-data', [SessionsController::class, 'getUserData'])->name('get-user-data');
